...
- **Code assistance and debugging**: AI was used to help write and debug JavaScript (OpenLayers integration, Turf.js spatial analysis functions), Python (Flask server, GeoPandas shapefile import), and CSS. The generated code was reviewed, understood, tested, and modified by the student.
